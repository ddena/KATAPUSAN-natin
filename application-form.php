...
if (isset($_POST['apply'])) {
    // get form inputs
    $first_name = $_POST['AFfname'];
    $middle_name = $_POST['AFmname'];
    $last_name = $_POST['AFlname'];
    $email = $_POST['AFemail'];
    ...
    if (!$alertMessage) {
        ...
        $sql_loan_type = "SELECT loan_type_name FROM tbl_loantype WHERE loan_type_id = $loan_type_id";
    ...
    if (!$alertMessage) {
        ...
        if ($conn->query($sql_loan) === TRUE) {
            ...
            $sql_payment = "INSERT INTO tbl_payment (loan_id, payment_amount, payment_date) 
   ...
   if ($alertType === 'success') {
    ...
    $id = $_SESSION['user_id'];
    $logssql = "INSERT INTO tbl_logs (user_id, action, datetime) VALUES ('$id', 'Submitted an Application', NOW())";
    $conn->query($logssql);
}
      ...
      <div class="form-group">
        <div class="row name-row">
          <div class="col">
            ...
            <input type="text" name="AFfname" value="">
          </div>
          <div class="col">
            <label>Middle Name</label>
            <input type="text" name="AFmname" value="">
          </div>
          <div class="col">
            <label>Last Name</label>
            <input type="text" name="AFlname" value="">
          </div>
        </div>
    ...
    <div class="footer-container mt-5">
      <div class="footer-column logo-column">
        <div class="footer-logo">
          <img src="img/fundifyme-transparent.png" alt="Logo">
        </div>
